...
public class FastFoodRestaurants {
    public static void main(String[] args) {
        ...
        System.out.println("Total number of restaurants: " + count);
//ALTERNATIVE s.out(restaurant.length)
        ...
        for (int y = 0; y <restaurants.length ; y++) {

            if(restaurants[y].toLowerCase().contains("mcdonalds")){
