...
public class IndexOfWith2Parameters {
    public static void main(String[] args) {
        ...
        // I dont know how many word in thi sentence.I only know there are 3+ words
        ...
        int secondSpace=name.indexOf(" ", firstSpaceLocation+1);//becasue I wanna search after the space
