...
public class DoWhileRepl111 {
    public static void main(String[] args) {


//        Given int variables k and total that have already been declared, use a do...while loop
//        to compute the sum of the squares of the first 50 counting numbers, and store this value in total.
