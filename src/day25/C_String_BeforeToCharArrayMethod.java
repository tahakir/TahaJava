...
public class C_String_BeforeToCharArrayMethod {
...
////      namesChars[5] = name.charAt(5);
        ...
        char[] charName3=new char[name3.length()];
        
        charName3=name3.toCharArray();
        System.out.println("char Name3 = " + Arrays.toString(charName3));
