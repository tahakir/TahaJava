...
public class B_SwappingValues {
    public static void main(String[] args) {

        String name1 = "Taha";
        String name2 = "Kaan";
        // name2 should have Taha , name1 should have Kaan
        //name1 = name2 ;
        //name2 = name1 ;



        String tempContainer = name1; // Taha
        name1 = name2;  //name1 -->> Kaan
        name2 = tempContainer; // name -->> Taha
