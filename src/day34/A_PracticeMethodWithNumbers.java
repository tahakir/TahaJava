...
public class A_PracticeMethodWithNumbers {
    public static void main(String[] args) {

        //DO NOT TREAT NUMBER AS A STRING
        // for example 376--> digit1 is 3, digit2 is 7, digit3 is 6

//        int digit1,digit2,digit3;  We don't need this anymore because we created return!!!
//        digit1=3;
//        digit2=7;
//        digit3=6;
//
...
//        System.out.println("number = " + number);
        ...
        System.out.println(build3DigitNumber(6,14,0)); //---->600 (because of the requirement)

        System.out.println(build3DigitNumber(16,14,90)); //---->0 (because of the requirement)

        //add the result of first 2 method call

        System.out.println("result1+result2 = " + (result1+result2));
        System.out.println(result1+result2+" is the result of result1+result2");
    }
