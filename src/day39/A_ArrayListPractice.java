...
public class A_ArrayListPractice {
...
//         * Task 8 : Count the items prices more than average price.
        ...
        System.out.println("Count the items prices more than average price = " + CNT);
        ...
        System.out.println("ProductList count after removing = " +productLst.size());
//         * OPTIONALLY :
